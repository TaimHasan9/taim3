...
const MensPage = () => {
  ...
  const products = [
    {
      ...
      price: 45.99,
      rating: 4.5,
      image: "https://images.unsplash.com/photo-1621072156002-e2fccdc0b176?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80",
      category: "Shirts",
      discount: 15
    },
    {
    ...
    },
    {
      ...
      price: 199.99,
      rating: 4.9,
      image: "https://image.made-in-china.com/202f0j00wcTbFAdIGhqW/Custom-Formal-Suits-Business-Suits-Wool-Blazer-Suit-Pants-Men-Wedding-Suit-Party-Men-Suits.webp",
      category: "Suits",
      discount: 25
    },
    {
  ...
  return (
    <div className="container px-4 py-12 mx-auto">
      <h1 className="mb-4 text-4xl font-bold text-center text-gray-800 dark:text-white">Men's Collection</h1>
      <p className="mb-12 text-center text-gray-600 dark:text-gray-400">Discover the latest trends in men's fashion</p>
